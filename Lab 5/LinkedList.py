...
class LinkedList:
    ...
    def __iter__(self):
        """
        allows the linked list to be iterated over by something like a for loop
        Parameters: None
    ...
    def add(self, item):
        """
        adds the specified item (as a node) to the beginning (head) of the linked list
        Parameters:
    ...
    def append(self, item):
        """
        adds the specified item (as a node) to the end (tail) of the linked list
        Parameters:
